...
void mostrarCreditos(int &opcion, Jugador &j1, Jugador &j2)
{
    ...
    string miguel = "Lardo Miguel Ángel - LEGAJO: 29812";
    string adriel = "Vázquez Adriel Alejandro - LEGAJO: 29930";
    string analia = "Leyez Analía Belén - LEGAJO: 29817";
    ...
    while (y >= pantallaAltura / 2) // Aca lo mismo, dividimos por dos para ubicar el centro.
    {
        ...
        cout << miguel << endl;
        rlutil::locate(x - 14, y);
        cout << analia;
        rlutil::locate(x - 16, y +2);
        cout << adriel;

        rlutil::locate(x - 24, y + 4);
        cout << equipo;
